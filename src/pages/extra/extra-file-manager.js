					...
					<div className={'file-manager h-100 ' + (isMobileSidebarToggled ? 'file-manager-sidebar-mobile-toggled' : '') }>
						...
						<div className="file-manager-container">
							...
							<div className="file-manager-content d-flex flex-column">
								<div className="mb-0 d-flex text-nowrap p-3 flex-wrap gap-2 border-bottom">
									<button type="button" className="btn btn-sm btn-white px-2"><i className="fa fa-fw fa-home"></i></button>
									<button type="button" className="btn btn-sm btn-white" disabled><i className="fa fa-fw fa-arrow-turn-up ms-n1"></i>  Up One Level</button>
									...
									<button type="button" className="btn btn-sm btn-white px-2"><i className="fa fa-fw fa-arrows-rotate"></i></button>
